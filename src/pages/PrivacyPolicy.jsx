  ...
  return (
    <section className="section privacy-policy-section">
      <Seo
        ...
        description="Lees het privacybeleid van Metz Nederland B.V. over verwerking van persoonsgegevens, cookies en rechten van bezoekers."
        keywords="privacy policy Metz Nederland, privacyverklaring, cookies, persoonsgegevens"
        breadcrumbItems={[
          { name: 'Home', path: '/' },
      ...
      <div className="container">
        ...
        <div className="privacy-content">
          <p>
            <strong>Metz Nederland B.V. </strong>respecteert de privacy van de bezoekers van haar website, in het bijzonder de rechten van bezoekers met betrekking tot de geautomatiseerde verwerking van persoonsgegevens. Vanwege volledige transparantie met onze klanten hebben wij daarom een beleid geformuleerd en geïmplementeerd met betrekking tot deze verwerkingen zelf, het doel ervan alsook de mogelijkheden voor betrokkenen om hun de rechten zo goed mogelijk te kunnen uitoefenen.
            Voor alle aanvullende informatie over de bescherming van persoonsgegevens kunt u terecht op de website van de Autoriteit persoonsgegevens: <a href="https://autoriteitpersoonsgegevens.nl/nl">https://autoriteitpersoonsgegevens.nl/nl</a>.
          </p>

          <p>Totdat u op de website het gebruik van cookies en andere tracking systems accepteert, plaatsen wij geen niet-geanonimiseerde analytische cookies en/of tracking cookies op uw computer, mobiele telefoon of tablet.</p>
          ...
          <h2><strong>Artikel 1 – Wettelijke bepalingen</strong></h2>
          <ol>
            <li>Website (hierna ook "De website"): <strong>www.metz-nederland.nl</strong></li>
            <li>Verantwoordelijke voor de verwerking van persoonsgegevens (Hierna ook: "De beheerder"): <strong>Metz Nederland B.V. , Nederland, KVK: 24294561</strong></li>
          </ol>

          <h2><strong>Artikel 2 – Toegang tot de website</strong></h2>
          ...
          <h2><strong>Artikel 3 – De content van de website</strong></h2>
          ...
          <h2><strong>Artikel 4 – Het beheer van de website</strong></h2>
          ...
          <h2><strong>Artikel 5 – Verantwoordelijkheden</strong></h2>
          <p>De beheerder is in geen geval verantwoordelijk voor falen, storingen, moeilijkheden of onderbrekingen van het functioneren van de website, waardoor de website of een van zijn functionaliteiten niet toegankelijk is. De wijze waarop u verbinding zoekt met de website is uw eigen verantwoordelijkheid. U dient zelf alle geschikte maatregelen te treffen om uw apparatuur en uw gegevens te beschermen tegen onder andere virusaanvallen op het internet. U bent bovendien zelfverantwoordelijk voor de websites en de gegevens die u op internet raadpleegt.</p>
          ...
          <h2><strong>Artikel 6 – Het verzamelen van gegevens</strong></h2>
          <p>Uw gegevens worden verzameld door <strong>Metz Nederland B.V. </strong> en (een) externe verwerker(s). Onder persoonsgegevens worden verstaan: alle informatie over een geïdentificeerde of identificeerbare natuurlijke persoon; als identificeerbaar wordt beschouwd een natuurlijke persoon die direct of indirect kan worden geïdentificeerd, met name aan de hand van een identificator zoals een naam, een identificatienummer, locatiegegevens, een online identificator of een of meer elementen die kenmerkend zijn voor de fysieke, fysiologische, genetische, psychische, economische, culturele of sociale identiteit.</p>
          ...
          <h2><strong>Artikel 7 – Uw rechten met betrekking tot uw gegevens</strong></h2>
          <p>Op grond van artikel 13 lid 2 sub b AVG heeft eenieder recht op inzage van en rectificatie of wissing van zijn persoonsgegevens of beperking van de hem betreffende verwerking, alsmede het recht tegen de verwerking bezwaar te maken en het recht op gegevensoverdraagbaarheid. U kunt deze rechten uitoefenen door contact met ons op te nemen via <strong>info@metz-nederland.nl</strong>.</p>

          <p>Ieder verzoek daartoe dient te worden vergezeld van een kopie van een geldig identiteitsbewijs, waarop u uw handtekening heeft gezet en onder vermelding van het adres waarop er met u contact kan worden opgenomen. Binnen 1 maand na het ingediende verzoek, krijgt u antwoord op uw verzoek. Afhankelijk van de complexiteit van de verzoeken en het aantal van de verzoeken kan deze termijn indien nodig met 2 maanden worden verlengd.</p>

          <h2><strong>Artikel 8 – Verwerking van persoonsgegevens</strong></h2>
          ...
          <h2><strong>Artikel 9 – Commerciële aanbiedingen</strong></h2>
          <p>U kunt commerciële aanbiedingen krijgen van de beheerder. Indien u deze niet (meer) wenst te ontvangen, stuurt u een mail naar het volgende adres: <strong>info@metz-nederland.nl</strong>.</p>
          ...
          <h2><strong>Artikel 10 – Bewaartermijn gegevens</strong></h2>
          ...
          <h2><strong>Artikel 11 – Cookies</strong></h2>
          <ol>
          ...
          <ul>
            <li><strong>Functionele cookies:</strong> zoals sessie- en login cookies voor het bijhouden van sessie- en inloginformatie.</li>
            <li><strong>Geanonimiseerde Analytische cookies:</strong> om inzage te krijgen in het bezoek aan onze website op basis van informatie over bezoekersaantallen, populaire pagina's en onderwerpen. Op deze wijze kunnen we de communicatie en informatievoorziening beter afstemmen op de behoeften van bezoekers van onze website. We kunnen niet zien wie onze websites bezoekt of vanaf welke pc het bezoek plaatsvindt.</li>
            <li><strong>Tracking cookies:</strong> zoals advertentiecookies die zijn bedoeld voor het tonen van relevante advertenties. Uit de informatie over bezochte websites kunnen persoonlijke interesses worden afgeleid. Daarmee kunnen organisaties hun websitebezoekers bijvoorbeeld gerichte advertenties tonen. Tracking cookies maken het mogelijk om profielen van mensen op te stellen en hen anders te behandelen. Met tracking cookies worden doorgaans persoonsgegevens verwerkt.</li>
          </ul>
          <ol start="3">
          ...
          <h2><strong>Artikel 12 – Beeldmateriaal en aangeboden producten</strong></h2>
          <p>Aan het beeldmateriaal dat behoort bij de aangeboden producten op de website kunnen geen rechten worden ontleend.</p>

          <h2><strong>Artikel 13 – Toepasselijk recht</strong></h2>
          ...
          <h2><strong>Artikel 14 – Contact</strong></h2>
          <p>Voor vragen, productinformatie of informatie over de website zelf, kunt u zich richten tot: <strong>info@metz-nederland.nl</strong></p>
        </div>
      </div>
    </section>
  );
